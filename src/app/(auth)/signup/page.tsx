...
import { Eye, EyeOff, UserPlus, Mail, Lock, User, ShieldCheck, Loader2, Timer, Check, MapPin, Star, ArrowRight, Zap } from 'lucide-react';
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#0a897d] via-[#0d9488] to-[#0a897d] relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center w-full max-w-md mx-auto px-10 xl:px-16 text-white">
          ...
          <h1 className="text-3xl xl:text-4xl font-bold mb-4 leading-tight">
            ...
            <span className="text-white/90">satisfied users</span>
          </h1>

          <p className="text-base text-white/75 mb-10 leading-relaxed">
            Discover local businesses, save favorites, and get personalized recommendations powered by AI.
          </p>
          ...
          <div className="space-y-4 mb-10">
            {[
              ...
              { icon: Star, text: 'Read and write authentic reviews' },
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-muted-foreground mt-1.5">
              {step === 'details'
                ? 'Start your journey with IndexOrbit today'
                : `Code sent to ${email}`
              }
            </p>
          </div>
            ...
            <form onSubmit={(e) => { e.preventDefault(); handleSendOtp(); }} className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex gap-1 mt-2">
                  {[passwordStrength.length, passwordStrength.uppercase && passwordStrength.lowercase, passwordStrength.number].map((passed, i) => (
                    <div key={i} className={`h-1 flex-1 rounded-full transition-colors ${passed ? 'bg-[#0a897d]' : 'bg-muted'}`} />
                  ))}
                </div>
              </div>
              ...
              <Button type="submit" className="w-full h-11 rounded-xl text-sm font-medium mt-2" disabled={isLoading}>
                {isLoading ? (
            ...
            <form onSubmit={handleVerifyOtp} className="space-y-5">
              ...
              <Button type="submit" className="w-full h-11 rounded-xl text-sm font-medium" disabled={isLoading || otp.length !== 6}>
                {isLoading ? (
                  ...
                  <><ShieldCheck className="mr-2 h-4 w-4" /> Verify & Create</>
                )}
              </Button>
          ...
          <p className="text-sm text-muted-foreground text-center mt-8">
            ...
            <Link href="/login" className="text-[#0a897d] hover:underline font-medium">
              Sign in
            </Link>
          </p>
