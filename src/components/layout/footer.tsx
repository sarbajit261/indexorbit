  ...
  return (
    <footer className="bg-white text-gray-600 border-t border-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        {/* Bottom section: Description + Contact + Social */}
        <div className="mt-12 pt-8 border-t border-gray-100">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-8 lg:text-right">
              <div className="flex flex-col sm:flex-row lg:justify-end items-start sm:items-center gap-4 text-sm text-gray-500">
              ...
              <div className="flex gap-3 mt-4 lg:justify-end">
